...
import { Competitor, CompetitorProduct, VisitCompetitor, VisitCompetitorState } from '@saleshub-tsm/types';
...
export const useCompetitorStore = create<VisitCompetitorState>((set, get) => ({
  ...
  addCompetitorToVisit: (item: Competitor | string) => {
    ...
    const newEntry: VisitCompetitor = {
      ...
      name: name,
      products: [{ product_name: '', brand: '', price: 0, monthly_usage: 0, unit: '', is_promo: false, notes: '', stock_status: 'AVAILABLE' }],
    };
  ...
  addProductToCompetitor: (compIndex: number) => {
    set((state) => {
      ...
      const updatedProducts: CompetitorProduct[] = [
        ...
        { product_name: '', brand: '', price: 0, monthly_usage: 0, unit: '', is_promo: false, notes: '', stock_status: 'AVAILABLE' },
      ];
  ...
  setCompetitors: (competitors: VisitCompetitor[]) =>
