        ...
        {purchaseHistory && purchaseHistory.lastPurchase && (
          <div className="flex flex-column gap-2">
            {purchaseHistory.lastPurchase && (
              <Card className="mb-3 p-3 shadow-2 px-0" title="Recent Purchases">
                  ...
                  <div className="grid">
                    {purchaseHistory.lastPurchase.map((item: ISalesInvoices, idx) => (
                      <div key={idx} className="col-12 md:col-6 lg:col-4">
                        <Card className="mb-3 p-3 h-[180px] shadow-2 px-0" title={item.Dscription}>
                  ...
                  <div className="grid mt-5">
                    {[spending, orders, invoices].map((item, idx) => (
                      <div className="col-12 sm:col-6 md:col-4" key={idx}>
                        <Card className="mb-3 p-3 h-[180px] shadow-2 px-0" title={item.label}>
                          <div className="flex flex-column gap-2">
