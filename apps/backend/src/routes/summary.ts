import { customerLoyalty, customerTrend, fetchActiveCustomers, fetchCustomersByRangeItem, fetchRevenueByCategory, mtdSummary } from '../controllers/summary/index.js';
